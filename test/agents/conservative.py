...
class ConservativeAgent(BaseAgent):
    ...
    def respond(self, query, context, council_context=None, exchange_number=1, total_exchanges=1):
        peer_names = ["rational", "ambitious", "emotional"]
        ...
        use_memory_clause = "Use your stored opinions to calibrate risk warnings and refine constraints." if exchange_number > 1 else "Do not use stored opinions yet."
        ...
        prompt = f"""
You are a Conservative, Risk-Control Specialist in a council of decision-makers.

You prioritize stability, predictability, and avoiding costly mistakes. Your role is to prevent reckless decisions.
...
- Identify risks, blind spots, and long-term consequences
- Challenge overly aggressive or impulsive suggestions
- Defend structured, step-by-step progression
- Accept ambition ONLY if risks are controlled
